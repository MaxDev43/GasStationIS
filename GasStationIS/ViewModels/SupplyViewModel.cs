...
namespace GasStationIS.ViewModels
{
    public class SupplyViewModel : BaseViewModel
    {
        ...
        public string   SupplierPhone    { get => _supplierPhone;    set => SetProperty(ref _supplierPhone, value); }
        ...
        public bool CanAdd =>
            !string.IsNullOrWhiteSpace(SupplierName) && SelectedFuelType != null;
        ...
        {
            SupplierName = SupplierPhone = QuantityText = PriceText = Notes = null;
