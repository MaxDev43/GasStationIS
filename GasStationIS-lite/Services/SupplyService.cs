    ...
    public static class SupplyService
    {
        public static List<FuelSupply> GetAll() =>
            DatabaseService.ExecuteReader(
                "SELECT s.id, s.supplier_name, s.fuel_type_id, " +
        ...
        public static void Add(FuelSupply supply)
        {
            ...
            DatabaseService.ExecuteNonQuery(
                ...
                "(supplier_name, fuel_type_id, quantity_liters, price_per_liter, total_cost, supply_date, employee_id) " +
                "VALUES (@sn, @fid, @qty, @ppl, @tc, @date, @eid);",
                cmd =>
                {
            ...
            // Пополняем остаток топлива в резервуаре
